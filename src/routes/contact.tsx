...
function ContactPage() {
  const { site, mailSettings, addContactMessage } = useSiteStore();
          ...
          {sent ? (
            <div className="mt-6 rounded-2xl border border-emerald-500/30 bg-emerald-500/10 p-6 text-center space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Thank you for reaching out. Your message has been logged and sent to {site.short}{" "}
                leadership.
              </p>
              {mailSettings.autoResponseEnabled || mailSettings.enabled ? (
                <div className="mt-2 rounded-lg bg-emerald-500/15 p-3 text-xs text-emerald-800 text-left">
                  <div className="font-bold flex items-center gap-1.5 text-emerald-900">
                    <CheckCircle2 className="h-4 w-4 text-emerald-600" />
                    Automated Auto-Response Dispatched
                  </div>
                  <div className="mt-1">
                    An instant confirmation email was dispatched from{" "}
                    <span className="font-mono font-bold text-emerald-950">
                      {mailSettings.senderEmail || "techwizardsassociation@gmail.com"}
                    </span>{" "}
                    to{" "}
                    <span className="font-mono font-bold text-emerald-950">
                      {lastEmail || "your email"}
                    </span>
                    .
                  </div>
                  <div className="mt-2 text-[11px] text-emerald-900/80 italic font-medium">
                    💡 Tip: If you don't see the email in your main Inbox, please check your Spam /
                    Junk folder or Promotions tab, or reach out directly to{" "}
                    <a
                      href="mailto:techwizardsassociation@gmail.com"
