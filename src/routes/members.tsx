...
import { useSiteStore, OfficeMember, getWhatsAppUrl } from "@/lib/site-store";
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {getWhatsAppUrl(m.whatsapp || m.phone) && (
                      <a
                        href={getWhatsAppUrl(
                          m.whatsapp || m.phone,
                          `Hello ${m.name}, reaching out to you from TWA SHASC website!`,
                        )}
                        target="_blank"
                        rel="noreferrer"
                        onClick={(e) => e.stopPropagation()}
                        className="p-1.5 rounded-lg text-emerald-600 dark:text-emerald-400 hover:bg-emerald-500/15 transition-smooth"
            ...
            <div className="pt-3 border-t border-border/80 flex flex-wrap items-center gap-2">
              ...
              {selectedMember.phone && (
                <a
                  ...
                  className="inline-flex items-center gap-1.5 rounded-xl border border-muted bg-muted/40 px-3 py-1.5 text-xs font-semibold text-foreground hover:bg-muted"
                >
                  <Phone className="h-3.5 w-3.5" /> Call
                </a>
              )}
              {getWhatsAppUrl(selectedMember.whatsapp || selectedMember.phone) && (
                <a
                  href={getWhatsAppUrl(
                    selectedMember.whatsapp || selectedMember.phone,
                    `Hello ${selectedMember.name}, I am contacting you from the Tech Wizard Association website.`,
                  )}
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-1.5 rounded-xl border border-emerald-500/40 bg-emerald-500/15 px-3 py-1.5 text-xs font-bold text-emerald-600 dark:text-emerald-400 hover:bg-emerald-500/25 transition-smooth"
                >
